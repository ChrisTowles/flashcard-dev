...
import type { ResolvedFontOptions } from '@flashcard-dev/types'
import { generateGoogleFontsUrl, parseAspectRatio, parseRangeString, stringifyMarkdownTokens } from './utils'
...
describe('utils', () => {
  ...
  it('stringify-markdown-tokens', () => {
    ...
    expect(stringify('Welcome to<br />*Flashcard-Dev*')).toBe('Welcome to Flashcard-Dev')
  })
