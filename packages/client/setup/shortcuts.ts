...
import type { NavOperations, ShortcutOptions } from '@flashcard-dev/types'
...
export default function setupShortcuts() {
  ...
  let injection_return: ShortcutOptions[] = [
    ...
    { name: 'toggle_dark', key: and(d), fn: toggleDark },
    { name: 'toggle_overview', key: and(o), fn: toggleOverview },
    { name: 'hide_overview', key: and(escape), fn: () => showOverview.value = false },
    { name: 'goto', key: and(g), fn: () => showGotoDialog.value = !showGotoDialog.value },
