...
import { blue, cyan, dim, green, yellow } from 'picocolors'

import { Presets, SingleBar } from 'cli-progress'
import { parseRangeString } from '@flashcard-dev/parser'
import type { FlashcardInfo } from '@flashcard-dev/types'
...
function addToTree(tree: TocItem[], info: FlashcardInfo, level = 1) {
...
export async function exportSlides({
  ...
  async function genPageMd(slides: FlashcardInfo[]) {
